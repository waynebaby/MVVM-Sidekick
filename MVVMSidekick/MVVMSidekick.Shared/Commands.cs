...
namespace MVVMSidekick
{
	...
	namespace Commands
	{
		...
		public class EventCommandEventArgs : EventArgs
		{
			...
			{
				_completion = new Lazy<TaskCompletionSource<EventCommandEventArgs>>(
					() => new TaskCompletionSource<EventCommandEventArgs>(), true);
			...
			public TaskCompletionSource<EventCommandEventArgs> Completion
			{
				get
				{
